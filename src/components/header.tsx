      ...
      >
        {user?.photoURL ? (
          ...
          <h1 className="text-3xl font-bold px-1 ">
             ...
             <img className="rounded-full " src="./image.jpg"  width={30}  height={10}  />
             
        </h1>
        )}
        <div className="flex flex-col items-start pr-2">
          <h1 className="text-black lg:text-lg lg:m-0 m-2 text-xs tracking-tight lg:font-bold font-bold font-sans">
            {user ? user.displayName : "Rajeev Ranjan"}
          </h1>
          {user && (
